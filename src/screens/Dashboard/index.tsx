...
export function Dashboard() {
  ...
  function getLastTransationDate(collection: DataListProps[], type: 'positive' | 'negative') {
 ...
 async function loadTransactions(){
  ...
  const lastTransactionEntries = getLastTransationDate(transactions, 'positive');
  const lastTransactionExpensies = getLastTransationDate(transactions, 'negative');
  ...
  // console.log(highlightData.entries.amount);
...
useFocusEffect(useCallback(()=> {
  ...
  return(
    ...
    <Header>
        <UserWrapper>
          <UserInfo>
            <Photo source={{uri: 'https://avatars.githubusercontent.com/u/66183705?v=4'}}/>
            <User>
              <UserGreeting>Olá, </UserGreeting>
              <UserName>Diones</UserName>
            </User>
          </UserInfo>
